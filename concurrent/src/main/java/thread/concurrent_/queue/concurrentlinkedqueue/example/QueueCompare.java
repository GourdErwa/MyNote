package thread.concurrent_.queue.concurrentlinkedqueue.example;
 ...
 *
 * @see thread.concurrent_.queue.concurrentlinkedqueue.example.QueueCompare.ConcurrentLinkedQueueMarket#consumer()
 * --------------------------------------------------------------------------
 * <p>
