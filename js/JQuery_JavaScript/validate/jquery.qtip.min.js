...
(function (e, t, n) {
    (function (e) {
        "use strict";
        typeof define == "function" && define.amd ? define(["jquery.qtip.min"], e) : jQuery && !jQuery.fn.qtip && e(jQuery)
    })(function (r) {
        function P(e) {
            var t = function (e) {
            ...
            y.id = m, y.rendered = s, y.destroyed = s, y.elements = q = {target: u}, y.timers = {img: {}}, y.options = a, y.checks = {}, y.plugins = {}, y.cache = R = {
                ...
                render: function (e) {
                    ...
                    if (r.isArray(o) && o.length === 2)l = {x: h, y: c}, k = {
                        ...
                        x: h,
                        y: c
                    }, n = E && E.pageX && (m.mouse || !n || !n.pageX) ? {
                        pageX: E.pageX,
                        pageY: E.pageY
                    } : (!n || n.type !== "resize" && n.type !== "scroll" ? n && n.pageX && n.type === "mousemove" ? n : !m.mouse && R.origin && R.origin.pageX && a.show.distance ? R.origin : n : R.event) || n || R.event || E || {}, k = {
                        top: n.pageY,
                        left: n.pageX
                    }; else {
