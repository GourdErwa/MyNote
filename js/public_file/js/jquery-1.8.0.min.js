...
(function (a, b) {
    ...
    cj = cs.exec(ci.toLowerCase()) || [], p.fn.load = function (a, c, d) {
        ...
        ajaxSettings: {
            ...
            global: !0,
            type: "GET",
            contentType: "application/B-www-form-urlencoded; charset=UTF-8",
            processData: !0,
            async: !0,
            accepts: {
    ...
    p.ajaxSetup({
        ...
        accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/B-ecmascript"},
